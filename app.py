...
app.config['MAIL_USERNAME'] = 'sarahglazier2@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = ' oqboqsrmeppfxbaw'# Your Gmail password or App Password
